Scriptname DS:StringArray Native Hidden Const
...
; returns true on success
; returns false if identifier is invalid or no array found by specified identifier
bool function AddRange(Keyword identifier, string[] toAdd) global native
...
string function Get(Keyword identifier, int index) global native
...
; - no array found by specified identifier
; - index is out of range
bool function Set(Keyword identifier, int index, string value) global native
...
; - no array found by specified identifier
; - index is out of range
bool function Insert(Keyword identifier, string value, int index) global native
...
; - no element found
int function IndexOf(Keyword identifier, string value, int startIndex) global native
