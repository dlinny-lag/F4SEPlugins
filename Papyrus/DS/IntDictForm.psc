Scriptname DS:IntDictForm Native Hidden Const

; creates an <Int, Form> dictionary
...
; Deletes previously created <Int, Form> dictionary
; returns true on success
...
bool function Add(Keyword identifier, int key, Form value) global native
...
; - identifier is invalid 
; - no dictionary found by specified identifier
bool function Set(Keyword identifier, int key, Form value) global native
...
; - no dictionary found by specified identifier
; - key does not exist
bool function Replace(Keyword identifier, int key, Form value) global native
