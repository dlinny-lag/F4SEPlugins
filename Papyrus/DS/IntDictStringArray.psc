Scriptname DS:IntDictStringArray Native Hidden Const

; creates an <Int, StringArray> dictionary
...
; Deletes previously created <Int, StringArray> dictionary
; returns true on success
...
; - no dictionary found by identifier
; - no array found by specified key
Result function GetElement(Keyword identifier, int key, int index) global native
...
; - identifier is invalid 
; - no array found by specified key
bool function AddElement(Keyword identifier, int key, string value) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function AddRange(Keyword identifier, int key, string[] toAdd) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function SetElement(Keyword identifier, int key, string value, int index) global native
...
bool function InsertElement(Keyword identifier, int key, string value, int index) global native
...
; - no element found
int function IndexOf(Keyword identifier, int key, string value, int startIndex) global native
...
; - identifier is invalid 
; - no array found by specified key
bool function SortArray(Keyword identifier, int key, int mode) global native
