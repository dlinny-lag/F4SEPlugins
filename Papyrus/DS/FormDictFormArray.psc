Scriptname DS:FormDictFormArray Native Hidden Const

; creates an <Form, FormArray> dictionary
...
; Deletes previously created <Form, FormArray> dictionary
; returns true on success
...
; - identifier is invalid 
; - no array found by specified key
bool function AddElement(Keyword identifier, Form key, Form value) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function AddRange(Keyword identifier, Form key, Form[] toAdd) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function SetElement(Keyword identifier, Form key, Form value, int index) global native
...
bool function InsertElement(Keyword identifier, Form key, Form value, int index) global native
...
; - no element found
int function IndexOf(Keyword identifier, Form key, Form value, int startIndex) global native
