Scriptname DS:StringDictStruct Native Hidden Const

; creates <String, struct> dictionary
...
; Deletes previously created <String, struct> dictionary
; returns true on success
...
var function Get(Keyword identifier, string key) global native
...
bool function Add(Keyword identifier, string key, var value) global native
...
; - no dictionary found by specified identifier
; - value is invalid. None is allowed
bool function Set(Keyword identifier, string key, var value) global native
...
; - no dictionary found by specified identifier
; - key does not exist
bool function Replace(Keyword identifier, string key, var value) global native
