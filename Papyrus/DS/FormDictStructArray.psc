Scriptname DS:FormDictStructArray Native Hidden Const

; creates <Form, StructArray> dictionary
...
; Deletes previously created <Form, StructArray> dictionary
; returns true on success
...
bool function Contains(Keyword identifier, Form key) global native
...
; - no dictionary found by specified identifier
; - no array found by specified key 
bool function Remove(Keyword identifier, Form key) global native
...
int function ArrayLength(Keyword identifier, Form key) global native
...
var function GetElement(Keyword identifier, Form key, int index) global native
...
; returns false if
; - identifier is invalid 
bool function AddElement(Keyword identifier, Form key, var value) global native
...
; - identifier is invalid 
; - no dictionary found by identifier
bool function AddRange(Keyword identifier, Form key, var[] toAdd) global native
...
; - no dictionary found by identifier
; - no array found by specified key. one could use Contains() to detect if array present in dictionary
bool function SetElement(Keyword identifier, Form key, var value, int index) global native
...
; - no dictionary found by identifier
; - no array found by specified key. one could use Contains() to detect if array present in dictionary
bool function RemoveAtIndex(Keyword identifier, Form key, int index) global native
...
; - no array found by specified key. one could use Contains() to detect if array present in dictionary
; - index is out of range
bool function InsertElement(Keyword identifier, Form key, var value, int index) global native
...
int function IndexOf(Keyword identifier, Form key, string fieldName, var fieldValue, int startIndex) global native
...
; - no dictionary found by identifier
; - no array found by specified key. one could use Contains() to detect if array present in dictionary
bool function SortArray(Keyword identifier, Form key, string fieldName, int mode) global native

; Copies keys of dictionary specified by identifier to DS:FormArray specified by arrayId
...
; Copies keys of dictionary specified by identifier to DS:FormSet specified by setId
...
; elements in DS:FormArray specified by arrayId interpreted as keys to remove
...
; removes key/value pairs from dictionary specified by identifier
; elements in DS:FormSet specified by setId interpreted as keys to remove
; returns amount of removed elements
; returns -1 if
; - identifier is invalid 
; - no dictionary found by specified identifier 
...
; appends elements of DS:FormArray specified by arrayId to array specified by key
; if array is not exist for this key then new array is created
; returns true if element was added successfully
; returns false if
; - identifier is invalid 
...
bool function AppendArray(Keyword identifier, Form key, Keyword arrayId) global native

; copies elements of array specified by key to DS:FormArray specified by destinationArrayId
; returns true on success
; returns false if
; - identifier is invalid 
; - no dictionary found by specified identifier 
...
bool function CopyToArray(Keyword identifier, Form key, Keyword targetArrayId) global native
