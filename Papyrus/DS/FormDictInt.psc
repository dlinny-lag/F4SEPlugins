Scriptname DS:FormDictInt Native Hidden Const

; creates an <Form, Int> dictionary
...
; Deletes previously created <Form, Int> dictionary
; returns true on success
...
bool function Add(Keyword identifier, Form key, int value) global native
...
; - identifier is invalid 
; - no dictionary found by specified identifier
bool function Set(Keyword identifier, Form key, int value) global native
...
; - no dictionary found by specified identifier
; - key does not exist
bool function Replace(Keyword identifier, Form key, int value) global native
