Scriptname DS:FormDictStringArray Native Hidden Const

; creates an <Form, StringArray> dictionary
...
; Deletes previously created <Form, StringArray> dictionary
; returns true on success
...
; - no dictionary found by identifier
; - no array found by specified key
Result function GetElement(Keyword identifier, Form key, int index) global native
...
; - identifier is invalid 
; - no array found by specified key
bool function AddElement(Keyword identifier, Form key, string value) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function AddRange(Keyword identifier, Form key, string[] toAdd) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function SetElement(Keyword identifier, Form key, string value, int index) global native
...
bool function InsertElement(Keyword identifier, Form key, string value, int index) global native
...
; - no element found
int function IndexOf(Keyword identifier, Form key, string value, int startIndex) global native
...
; - identifier is invalid 
; - no array found by specified key
bool function SortArray(Keyword identifier, Form key, int mode) global native
