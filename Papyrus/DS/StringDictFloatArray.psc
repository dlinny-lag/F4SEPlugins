Scriptname DS:StringDictFloatArray Native Hidden Const

; creates an <String, FloatArray> dictionary
...
; Deletes previously created <String, FloatArray> dictionary
; returns true on success
...
; - identifier is invalid 
; - no array found by specified key
bool function AddElement(Keyword identifier, string key, float value) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function AddRange(Keyword identifier, string key, float[] toAdd) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function SetElement(Keyword identifier, string key, float value, int index) global native
...
bool function InsertElement(Keyword identifier, string key, float value, int index) global native
...
; - no element found
int function IndexOf(Keyword identifier, string key, float value, int startIndex) global native
