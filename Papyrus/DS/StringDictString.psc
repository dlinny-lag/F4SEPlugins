Scriptname DS:StringDictString Native Hidden Const

; creates an <String, String> dictionary
...
; Deletes previously created <String, String> dictionary
; returns true on success
...
Result function Get(Keyword identifier, string key) global native
...
bool function Add(Keyword identifier, string key, string value) global native
...
; - identifier is invalid 
; - no dictionary found by specified identifier
bool function Set(Keyword identifier, string key, string value) global native
...
; - no dictionary found by specified identifier
; - key does not exist
bool function Replace(Keyword identifier, string key, string value) global native
