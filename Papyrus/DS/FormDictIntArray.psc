Scriptname DS:FormDictIntArray Native Hidden Const

; creates an <Form, IntArray> dictionary
...
; Deletes previously created <Form, IntArray> dictionary
; returns true on success
...
; - identifier is invalid 
; - no array found by specified key
bool function AddElement(Keyword identifier, Form key, int value) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function AddRange(Keyword identifier, Form key, int[] toAdd) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function SetElement(Keyword identifier, Form key, int value, int index) global native
...
bool function InsertElement(Keyword identifier, Form key, int value, int index) global native
...
; - no element found
int function IndexOf(Keyword identifier, Form key, int value, int startIndex) global native
