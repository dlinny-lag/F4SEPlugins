Scriptname DS:IntDictInt Native Hidden Const

; creates an <Int, Int> dictionary
...
; Deletes previously created <Int, Int> dictionary
; returns true on success
...
bool function Add(Keyword identifier, int key, int value) global native
...
; - identifier is invalid 
; - no dictionary found by specified identifier
bool function Set(Keyword identifier, int key, int value) global native
...
; - no dictionary found by specified identifier
; - key does not exist
bool function Replace(Keyword identifier, int key, int value) global native
