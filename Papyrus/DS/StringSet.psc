Scriptname DS:StringSet Native Hidden Const
...
bool function Add(Keyword identifier, string value) global native
...
; - identifier is invalid
; - no set found by specified identifier 
int function AddRange(Keyword identifier, string[] toAdd) global native
...
bool function Remove(Keyword identifier, string value) global native
...
; - identifier is invalid 
; - no set found by specified identifier 
int function RemoveRange(Keyword identifier, string[] toRemove) global native
...
bool function Intersect(Keyword identifier, string[] other) global native
...
; - no set found by specified identifier
; - element was not found in the set
bool function Contains(Keyword identifier, string value) global native
...
; copies content of the set identified by identifier to DS:StringArray identified by arrayId
...
; - identifier is invalid
; - no set found by specified identifier 
string[] function ToArray(Keyword identifier) global native

; adds elements of DS:StringArray specified by arrayId to set specified by identifier
...
; adds elements of DS:StringSet specified by setId to set specified by identifier
; returns amount of inserted elements if any elements was inserted
; returns -1 if
; - identifier is invalid
; - no set found by specified identifier 
...
; intersects set specified by identifier with DS:StringArray elements
; modifies set in place and keeps only elements that contained in both - set and DS:StringArray
; in other words, elements that are not contained in DS:StringArray will be removed from the set 
; returns true if collection was changed
bool function IntersectArray(Keyword identifier, Keyword arrayId) global native

; intersects set specified by identifier with DS:StringSet elements
; modifies set in place and keeps only elements that contained in both - set and DS:StringSet
; in other words, elements that are not contained in DS:StringSet will be removed from the set 
; returns true if collection was changed
bool function IntersectSet(Keyword identifier, Keyword setId) global native

; removes elements of DS:StringArray specified by arrayId from set specified by identifier
...
; removes elements of DS:StringSet specified by setId from set specified by identifier
; returns amount of removed elements 
; returns -1 if
; - identifier is invalid 
; - no set found by specified identifier 
