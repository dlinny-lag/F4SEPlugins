Scriptname DS:IntDictString Native Hidden Const

; creates an <Int, String> dictionary
...
; Deletes previously created <Int, String> dictionary
; returns true on success
...
Result function Get(Keyword identifier, int key) global native
...
bool function Add(Keyword identifier, int key, string value) global native
...
; - identifier is invalid 
; - no dictionary found by specified identifier
bool function Set(Keyword identifier, int key, string value) global native
...
; - no dictionary found by specified identifier
; - key does not exist
bool function Replace(Keyword identifier, int key, string value) global native
