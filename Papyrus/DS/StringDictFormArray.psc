Scriptname DS:StringDictFormArray Native Hidden Const

; creates an <String, FormArray> dictionary
...
; Deletes previously created <String, FormArray> dictionary
; returns true on success
...
; - identifier is invalid 
; - no array found by specified key
bool function AddElement(Keyword identifier, string key, Form value) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function AddRange(Keyword identifier, string key, Form[] toAdd) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function SetElement(Keyword identifier, string key, Form value, int index) global native
...
bool function InsertElement(Keyword identifier, string key, Form value, int index) global native
...
; - no element found
int function IndexOf(Keyword identifier, string key, Form value, int startIndex) global native
