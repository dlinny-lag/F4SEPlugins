Scriptname DS:StringDictForm Native Hidden Const

; creates an <String, Form> dictionary
...
; Deletes previously created <String, Form> dictionary
; returns true on success
...
bool function Add(Keyword identifier, string key, Form value) global native
...
; - identifier is invalid 
; - no dictionary found by specified identifier
bool function Set(Keyword identifier, string key, Form value) global native
...
; - no dictionary found by specified identifier
; - key does not exist
bool function Replace(Keyword identifier, string key, Form value) global native
