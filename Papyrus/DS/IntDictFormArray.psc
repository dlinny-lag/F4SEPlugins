Scriptname DS:IntDictFormArray Native Hidden Const

; creates an <Int, FormArray> dictionary
...
; Deletes previously created <Int, FormArray> dictionary
; returns true on success
...
; - identifier is invalid 
; - no array found by specified key
bool function AddElement(Keyword identifier, int key, Form value) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function AddRange(Keyword identifier, int key, Form[] toAdd) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function SetElement(Keyword identifier, int key, Form value, int index) global native
...
bool function InsertElement(Keyword identifier, int key, Form value, int index) global native
...
; - no element found
int function IndexOf(Keyword identifier, int key, Form value, int startIndex) global native
