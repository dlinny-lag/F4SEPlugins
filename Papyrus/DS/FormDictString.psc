Scriptname DS:FormDictString Native Hidden Const

; creates an <Form, String> dictionary
...
; Deletes previously created <Form, String> dictionary
; returns true on success
...
Result function Get(Keyword identifier, Form key) global native
...
bool function Add(Keyword identifier, Form key, string value) global native
...
; - identifier is invalid 
; - no dictionary found by specified identifier
bool function Set(Keyword identifier, Form key, string value) global native
...
; - no dictionary found by specified identifier
; - key does not exist
bool function Replace(Keyword identifier, Form key, string value) global native
