Scriptname DS:FloatArray Native Hidden Const
...
; returns true on success
; returns false if identifier is invalid or no array found by specified identifier
bool function AddRange(Keyword identifier, float[] toAdd) global native
...
float function Get(Keyword identifier, int index) global native
...
; - no array found by specified identifier
; - index is out of range
bool function Set(Keyword identifier, int index, float value) global native
...
; - no array found by specified identifier
; - index is out of range
bool function Insert(Keyword identifier, float value, int index) global native
...
; - no element found
int function IndexOf(Keyword identifier, float value, int startIndex) global native
