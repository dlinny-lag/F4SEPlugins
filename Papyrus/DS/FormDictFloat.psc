Scriptname DS:FormDictFloat Native Hidden Const

; creates an <Form, Float> dictionary
...
; Deletes previously created <Form, Float> dictionary
; returns true on success
...
bool function Add(Keyword identifier, Form key, float value) global native
...
; - identifier is invalid 
; - no dictionary found by specified identifier
bool function Set(Keyword identifier, Form key, float value) global native
...
; - no dictionary found by specified identifier
; - key does not exist
bool function Replace(Keyword identifier, Form key, float value) global native
