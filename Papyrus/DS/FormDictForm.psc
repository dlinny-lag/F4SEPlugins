Scriptname DS:FormDictForm Native Hidden Const

; creates an <Form, Form> dictionary
...
; Deletes previously created <Form, Form> dictionary
; returns true on success
...
bool function Add(Keyword identifier, Form key, Form value) global native
...
; - identifier is invalid 
; - no dictionary found by specified identifier
bool function Set(Keyword identifier, Form key, Form value) global native
...
; - no dictionary found by specified identifier
; - key does not exist
bool function Replace(Keyword identifier, Form key, Form value) global native
