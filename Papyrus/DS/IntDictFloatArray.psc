Scriptname DS:IntDictFloatArray Native Hidden Const

; creates an <Int, FloatArray> dictionary
...
; Deletes previously created <Int, FloatArray> dictionary
; returns true on success
...
; - identifier is invalid 
; - no array found by specified key
bool function AddElement(Keyword identifier, int key, float value) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function AddRange(Keyword identifier, int key, float[] toAdd) global native
...
; - no dictionary found by identifier
; - no array found by specified key
bool function SetElement(Keyword identifier, int key, float value, int index) global native
...
bool function InsertElement(Keyword identifier, int key, float value, int index) global native
...
; - no element found
int function IndexOf(Keyword identifier, int key, float value, int startIndex) global native
