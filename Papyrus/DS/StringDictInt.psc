Scriptname DS:StringDictInt Native Hidden Const

; creates an <String, Int> dictionary
...
; Deletes previously created <String, Int> dictionary
; returns true on success
...
bool function Add(Keyword identifier, string key, int value) global native
...
; - identifier is invalid 
; - no dictionary found by specified identifier
bool function Set(Keyword identifier, string key, int value) global native
...
; - no dictionary found by specified identifier
; - key does not exist
bool function Replace(Keyword identifier, string key, int value) global native
