Scriptname DS:FormDictStruct Native Hidden Const

; creates <Form, struct> dictionary
...
; Deletes previously created <Form, struct> dictionary
; returns true on success
...
var function Get(Keyword identifier, Form key) global native
...
bool function Add(Keyword identifier, Form key, var value) global native
...
; - no dictionary found by specified identifier
; - value is invalid. None is allowed
bool function Set(Keyword identifier, Form key, var value) global native
...
; - no dictionary found by specified identifier
; - key does not exist
bool function Replace(Keyword identifier, Form key, var value) global native
