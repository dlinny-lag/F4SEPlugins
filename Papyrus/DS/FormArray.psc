Scriptname DS:FormArray Native Hidden Const
...
; returns true on success
; returns false if identifier is invalid or no array found by specified identifier
bool function AddRange(Keyword identifier, Form[] toAdd) global native
...
Form function Get(Keyword identifier, int index) global native
...
; - no array found by specified identifier
; - index is out of range
bool function Set(Keyword identifier, int index, Form value) global native
...
; - no array found by specified identifier
; - index is out of range
bool function Insert(Keyword identifier, Form value, int index) global native
...
; - no element found
int function IndexOf(Keyword identifier, Form value, int startIndex) global native
