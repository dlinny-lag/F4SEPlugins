Scriptname DS:StringDictFloat Native Hidden Const

; creates an <String, Float> dictionary
...
; Deletes previously created <String, Float> dictionary
; returns true on success
...
bool function Add(Keyword identifier, string key, float value) global native
...
; - identifier is invalid 
; - no dictionary found by specified identifier
bool function Set(Keyword identifier, string key, float value) global native
...
; - no dictionary found by specified identifier
; - key does not exist
bool function Replace(Keyword identifier, string key, float value) global native
