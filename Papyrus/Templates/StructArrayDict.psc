Scriptname DS:{keyTypeName}DictStructArray Native Hidden Const

; creates <{keyTypeName}, StructArray> dictionary
...
; Deletes previously created <{keyTypeName}, StructArray> dictionary
; returns true on success
...
var function GetElement(Keyword identifier, {keyType} key, int index) global native
...
; returns false if
; - identifier is invalid 
bool function AddElement(Keyword identifier, {keyType} key, var value) global native
...
; - identifier is invalid 
; - no dictionary found by identifier
bool function AddRange(Keyword identifier, {keyType} key, var[] toAdd) global native
...
; - no dictionary found by identifier
; - no array found by specified key. one could use Contains() to detect if array present in dictionary
bool function SetElement(Keyword identifier, {keyType} key, var value, int index) global native
...
; - no array found by specified key. one could use Contains() to detect if array present in dictionary
; - index is out of range
bool function InsertElement(Keyword identifier, {keyType} key, var value, int index) global native
...
int function IndexOf(Keyword identifier, {keyType} key, string fieldName, var fieldValue, int startIndex) global native
...
; - no dictionary found by identifier
; - no array found by specified key. one could use Contains() to detect if array present in dictionary
bool function SortArray(Keyword identifier, {keyType} key, string fieldName, int mode) global native
