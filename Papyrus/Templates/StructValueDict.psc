Scriptname DS:{keyTypeName}DictStruct Native Hidden Const

; creates <{keyTypeName}, struct> dictionary
...
; Deletes previously created <{keyTypeName}, struct> dictionary
; returns true on success
...
var function Get(Keyword identifier, {keyType} key) global native
...
bool function Add(Keyword identifier, {keyType} key, var value) global native
...
; - no dictionary found by specified identifier
; - value is invalid. None is allowed
bool function Set(Keyword identifier, {keyType} key, var value) global native
...
; - no dictionary found by specified identifier
; - key does not exist
bool function Replace(Keyword identifier, {keyType} key, var value) global native
