Scriptname DS:{hiName}Set Native Hidden Const
...
bool function Add(Keyword identifier, {loName} value) global native
...
; - identifier is invalid
; - no set found by specified identifier 
int function AddRange(Keyword identifier, {loName}[] toAdd) global native
...
bool function Remove(Keyword identifier, {loName} value) global native
...
; - identifier is invalid 
; - no set found by specified identifier 
int function RemoveRange(Keyword identifier, {loName}[] toRemove) global native
...
bool function Intersect(Keyword identifier, {loName}[] other) global native
...
; - no set found by specified identifier
; - element was not found in the set
bool function Contains(Keyword identifier, {loName} value) global native
...
; copies content of the set identified by identifier to DS:{hiName}Array identified by arrayId
...
; - identifier is invalid
; - no set found by specified identifier 
{loName}[] function ToArray(Keyword identifier) global native

; adds elements of DS:{hiName}Array specified by arrayId to set specified by identifier
...
; adds elements of DS:{hiName}Set specified by setId to set specified by identifier
; returns amount of inserted elements if any elements was inserted
; returns -1 if
; - identifier is invalid
; - no set found by specified identifier 
...
; intersects set specified by identifier with DS:{hiName}Array elements
; modifies set in place and keeps only elements that contained in both - set and DS:{hiName}Array
; in other words, elements that are not contained in DS:{hiName}Array will be removed from the set 
; returns true if collection was changed
bool function IntersectArray(Keyword identifier, Keyword arrayId) global native

; intersects set specified by identifier with DS:{hiName}Set elements
; modifies set in place and keeps only elements that contained in both - set and DS:{hiName}Set
; in other words, elements that are not contained in DS:{hiName}Set will be removed from the set 
; returns true if collection was changed
bool function IntersectSet(Keyword identifier, Keyword setId) global native

; removes elements of DS:{hiName}Array specified by arrayId from set specified by identifier
...
; removes elements of DS:{hiName}Set specified by setId from set specified by identifier
; returns amount of removed elements 
; returns -1 if
; - identifier is invalid 
; - no set found by specified identifier 
