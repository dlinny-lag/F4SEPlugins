Scriptname DS:{hiName}Array Native Hidden Const
...
; returns true on success
; returns false if identifier is invalid or no array found by specified identifier
bool function AddRange(Keyword identifier, {loName}[] toAdd) global native
...
{loName} function Get(Keyword identifier, int index) global native
...
; - no array found by specified identifier
; - index is out of range
bool function Set(Keyword identifier, int index, {loName} value) global native
...
; - no array found by specified identifier
; - index is out of range
bool function Insert(Keyword identifier, {loName} value, int index) global native
...
; - no element found
int function IndexOf(Keyword identifier, {loName} value, int startIndex) global native
